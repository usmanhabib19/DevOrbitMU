    ...
    <footer className="border-t border-gray-800 py-6 mt-12">
        <div className="max-w-5xl mx-auto flex justify-between items-center px-6 text-gray-400 text-sm">
            ...
            <div className="flex gap-4">
                <a href="https://github.com/usmanhabib19" target="_blank" rel="noreferrer"><Github size={18} /></a>
                <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noreferrer"><Linkedin size={18} /></a>
